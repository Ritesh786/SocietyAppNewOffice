...
public class RequestedTabdesignFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position)
        {
            switch (position){
                ...
                case 0 :PendingRequest dashfab = new PendingRequest();
                    FragmentManager manager = getFragmentManager();
                    manager.beginTransaction().commit();
                    Log.d("tab0123", String.valueOf(strtext));
                    return dashfab;

                case 1 :  ApprovedRequest pendfrag = new ApprovedRequest();
                FragmentManager manager12 = getFragmentManager();
                manager12.beginTransaction().commit();
                Log.d("tab0123", String.valueOf(strtext));
                return pendfrag;

                case 2 :  RejectedRequest verfeb = new RejectedRequest();
