 ...
 */
public class ApprovedNews extends Fragment {


    private static final String TAG = ApprovedNews.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_approved_news, container, false);
