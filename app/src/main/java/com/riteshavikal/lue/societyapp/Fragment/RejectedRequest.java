 ...
 */
public class RejectedRequest extends Fragment {

    private static final String TAG = RejectedRequest.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rejected_request, container, false);
