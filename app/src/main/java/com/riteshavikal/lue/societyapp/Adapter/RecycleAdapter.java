package com.riteshavikal.lue.societyapp.Adapter;
...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MyViewHolder> {
    ...
    private  List<MainSingleton> movieItems;
    Context context;
    ...
    public RecycleAdapter(List<MainSingleton> moviesList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        MainSingleton movie = movieItems.get(position);

        imageLoader.get(movie.getImage(), ImageLoader.getImageListener(holder.thumbNail, R.mipmap.ic_launcher, R.mipmap.ic_launcher));

        holder.title.setText(movie.getTitle());
        holder.genre.setText(movie.getDescriptionn());
      ...
      //  holder.rating.setText(""+movie.getRating());
       // Picasso.with(context).load(movieItems.get(position).getThumbnailUrl()).into(holder.thumbNail);
        ...
        else
        {
            ...
            try {
                holder.thumbNail.setImageUrl(movieItems.get(position).getImage(), imageLoader);
            }catch (Exception e){
